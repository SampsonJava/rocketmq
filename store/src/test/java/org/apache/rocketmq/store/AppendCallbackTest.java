...
public class AppendCallbackTest {
    ...
    public void init() throws Exception {
        ...
        messageStoreConfig.setStorePathRootDir(System.getProperty("user.dir") + File.separator + "unitteststore");
        messageStoreConfig.setStorePathCommitLog(System.getProperty("user.dir") + File.separator + "unitteststore" + File.separator + "commitlog");
        //too much reference
    ...
    @After
    public void destroy() {
        UtilAll.deleteFile(new File(System.getProperty("user.dir") + File.separator + "unitteststore"));
    }
